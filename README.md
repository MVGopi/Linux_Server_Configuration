...
You can visit http://54.91.75.70/ or http://ec2-54-91-75-70.compute-1.amazonaws.com/ for the website deployed.
...
Step 7: Create an SSH key pair for grader
  ...
  On the local machine, cheking if the grader account working or not by running this command : ssh -i item_catalog_1-3-2019.pem -p 2200 grader@54.91.75.70  
...
Step 12.1: Clone and setup the Item Catalog project from the GitHub repository
  ...
  Rename the mainpage.py file to __init__.py using: mv mobiles_store.py __init__.py.

  We need to change sqlite to postgresql create_engine in __init__.py,mobiles_database_setup.py and mobiles_data_insertion.py,

  # db_engine = create_engine("sqlite:///catalog.db")

    db_engine = create_engine('postgresql://catalog:catalog@localhost/catalog')
...
Step 12.2: Authenticate login through Google
  ...
  Create an OAuth Client ID (under the Credentials tab), and add http://54.91.75.70.xip.io and http://ec2-54-91-75-70.compute-1.amazonaws.com/ as authorized JavaScript origins.

  Add http://54.91.75.70,http://54.91.75.70/home as authorized redirect URI.
...
Paste this code:
  ...
  <VirtualHost *:80>
  ServerName 54.91.75.70.xip.io
  ServerAlias ec2-54-91-75-70.compute-1.amazonaws.com
  ServerAdmin ubuntu@54.91.75.70
...
Step 13.5: Launch the Web Application
  ...
  Open your browser to http://54.91.75.70 or http://ec2-54-91-75-70.us-east-2.compute.amazonaws.com.
